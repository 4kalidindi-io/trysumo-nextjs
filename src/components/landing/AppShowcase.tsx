...
const apps: AppCard[] = [
  ...
  },
  {
    ...
    title: 'Calorie AI',
    description: 'Snap a food photo and get instant nutritional analysis.',
    gradient: 'from-emerald-500 to-teal-500',
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    ...
    description: 'Test your knowledge with AI-powered answer checking.',
    gradient: 'from-amber-500 to-orange-500',
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    features: ['10-second buzzer', 'AI answer checking', 'Score tracking'],
  },
  {
    href: '/games/top7',
    title: 'Top 7',
    description: 'Guess the most popular answers in this Family Feud-style game.',
    ...
    features: ['20 fun prompts', '5 rounds', 'Family-friendly'],
  },
  {
